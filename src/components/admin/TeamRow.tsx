...
export function TeamRow({ team }: { team: Team }) {
  ...
  return (
    <div className="flex flex-col gap-3 border-b border-ink/10 py-4 last:border-b-0 sm:flex-row sm:items-center">
      {team.logoUrl ? (
      ...
      <form
        ...
        className="grid flex-1 grid-cols-2 items-center gap-2 sm:grid-cols-7"
      >
        ...
        <input
          ...
          className="h-9 w-full border border-ink/30"
        />
        <input
          type="color"
          name="secondaryColor"
          defaultValue={team.secondaryColor ?? "#ffffff"}
          className="h-9 w-full border border-ink/30"
        />
