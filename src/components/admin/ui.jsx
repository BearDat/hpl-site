export function Panel({ title, children, }) {
    return (<div className="mb-8 border-[3px] border-ink bg-surface p-6">
      <h2 className="mb-4 font-display text-lg">{title}</h2>
      {children}
    </div>);
}
export const inputClass = "w-full border border-ink/30 bg-surface px-3 py-2 text-sm focus:border-accent focus:outline-none";
