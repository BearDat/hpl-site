  ...
  return (
    <div>
      ...
      <Panel title="Articles">
        {articles.length === 0 ? (
          <p className="text-sm opacity-60">No articles yet.</p>
        ) : (
      ...
      <Panel title="Media Library">
        {media.length === 0 ? (
          <p className="text-sm opacity-60">No media uploaded yet.</p>
        ) : (
          <div className="flex flex-col gap-2">
            {media.map((m) => (
              <div key={m.id} className="flex items-center justify-between border-b border-ink/10 py-2 text-sm">
      ...
      <Panel title="Top Prospects">
        <div className="mb-4 flex flex-col gap-2">
          {prospects.map((p) => {
            ...
            return (
              <div key={p.id} className="flex items-center gap-3 border-b border-ink/10 py-2 text-sm">
