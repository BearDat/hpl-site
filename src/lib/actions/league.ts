...
export async function updatePlayoffFormat(seasonId: string, formData: FormData) {
...
export async function addTeamToSeason(formData: FormData) {
  ...
  if (!seasonId || !teamId) throw new Error("Season and team are required.");
...
export async function removeTeamFromSeason(formData: FormData) {
