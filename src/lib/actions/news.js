...
async function uniqueArticleSlug(title) {
    return uniqueSlug(title, async (slug) => (await prisma.newsArticle.findUnique({ where: { slug } })) !== null, "article");
}
async function heroImageUrlFromForm(formData) {
